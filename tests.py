...
class CaesarTestCase(TestCase):
    ...
    def test_encrypt(self):
        ...
        self.assertEqual(
            self.c.encrypt("Чу, я слышу пушек гром!", 100, 'rus'),
    ...
    def test_encrypt_modular(self):
        ...
        self.assertEqual(self.c.encrypt_modular("Ви говорите англійською?", 1, 'ukr'), "Selected language is not supported!")
    ...
    def test_decrypt_modular(self):
        ...
        self.assertEqual(self.c.decrypt_modular("Ви говорите англійською?", 1, 'ukr'), "Selected language is not supported!")
